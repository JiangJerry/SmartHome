...
/** @defgroup HT32F5xxxx_BOARD_Global_Variable HT32F5xxxx Board global variables
  ...
  */
  ...
  const u8 LED_GPIO_ID[LEDn] = {  LED1_GPIO_ID, 
                                  LED2_GPIO_ID, 
                                  LED3_GPIO_ID,
                                  RY1_GPIO_ID,
                                  RY2_GPIO_ID,
  ...
  const u16 LED_GPIO_PIN[LEDn] = {  LED1_GPIO_PIN, 
                                    LED2_GPIO_PIN,
                                    LED3_GPIO_PIN,
                                    RY1_GPIO_PIN,
                                    RY2_GPIO_PIN,
  ...
  const AFIO_MODE_Enum LED_AFIO_MODE[LEDn] = {  LED1_AFIO_MODE, 
                                                LED2_AFIO_MODE, 
                                                LED3_AFIO_MODE,
                                                RY1_AFIO_MODE,
                                                RY2_AFIO_MODE,
  ...
  const u8 BUTTON_GPIO_ID[BUTTONn] = {  WAKEUP_BUTTON_GPIO_ID, 
                                        KEY1_BUTTON_GPIO_ID,
                                        KEY2_BUTTON_GPIO_ID,
                                        LIMIT_SW1_GPIO_ID,
                                        LIMIT_SW2_GPIO_ID,
  ...
  const u16 BUTTON_GPIO_PIN[BUTTONn] = {WAKEUP_BUTTON_GPIO_PIN, 
                                        KEY1_BUTTON_GPIO_PIN, 
  ...
  const AFIO_MODE_Enum BUTTON_AFIO_MODE[BUTTONn] = {WAKEUP_BUTTON_AFIO_MODE,
                                                    KEY1_BUTTON_AFIO_MODE, 
                                                    KEY2_BUTTON_AFIO_MODE,
                                                    LIMIT_SW1_AFIO_MODE,
                                                    LIMIT_SW2_AFIO_MODE,
                                                    LIMIT_SW3_AFIO_MODE,
                                                    LIMIT_SW4_AFIO_MODE,
  ...
  const u8 BUTTON_EXTI_CH[BUTTONn] = {  WAKEUP_BUTTON_EXTI_CHANNEL, 
                                        KEY1_BUTTON_EXTI_CHANNEL, 
                                        KEY2_BUTTON_EXTI_CHANNEL,
                                        LIMIT_SW1_EXTI_CHANNEL,
                                        LIMIT_SW2_EXTI_CHANNEL,
                                        LIMIT_SW3_EXTI_CHANNEL,
                                        LIMIT_SW4_EXTI_CHANNEL,
                                        CLOSE_SW1_EXTI_CHANNEL,
                                        CLOSE_SW2_EXTI_CHANNEL,
                                        CLOSE_SW3_EXTI_CHANNEL,
                                        CLOSE_SW4_EXTI_CHANNEL
  };
...
void HT32F_DVB_PBInit(BUTTON_TypeDef BUTTON_x, BUTTON_MODE_TypeDef BUTTON_MODE_x)
{
    ...
    if(BUTTON_x != BUTTON_KEY1)
    {
        GPIO_PullResistorConfig(GPIOx, uGpioPin, GPIO_PR_UP); //´øÉÏÀ­
    }
  ...
  if (BUTTON_MODE_x == BUTTON_MODE_EXTI)
  {
    ...
    EXTI_InitStruct.EXTI_IntType = (BUTTON_x == BUTTON_WAKEUP) ? EXTI_POSITIVE_EDGE : EXTI_BOTH_EDGE;
